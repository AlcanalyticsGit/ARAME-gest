...
-- Tiempo de generación: 06-02-2023 a las 16:05:38
...
-- Base de datos: `arame`
--
CREATE DATABASE IF NOT EXISTS `arame` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `arame`;
...
`usuario`.`usr_nombre` 'username',
`usuario`.`usr_rol` 'rol'
FROM `usuario`
WHERE `usuario`.`usr_nombre`=nombreUsuario
...
--
-- Volcado de datos para la tabla `empresas_pertenecen_sectores`
--
...
INSERT INTO `premio` (`premio_year`, `premio_socia`) VALUES
(2022, 43),
(2022, 74),
(2022, 161),
(2022, 163);
...
--
-- Volcado de datos para la tabla `socia`
--
...
--
-- Volcado de datos para la tabla `socias_pertenecen_empresas`
--
...
INSERT INTO `usuario` (`usr_nombre`, `usr_pass`, `usr_rol`) VALUES
('admin', '922c282e5b4f2d96d78126943166732ea7fbd4f5', 10),
('usuario', 'b665e217b51994789b02b1838e730d6b93baa30f', 30);

-- --------------------------------------------------------

--
-- Estructura para la vista `consultar_correos_socias`
--
...
--
-- Estructura para la vista `consultar_empresas`
--
...
--
-- Estructura para la vista `consultar_sectores`
--
...
--
-- Estructura para la vista `consultar_socias`
--
...
--
-- Estructura para la vista `consultar_years_recibos`
--
...
--
-- Estructura para la vista `ver_socias_activas`
--
